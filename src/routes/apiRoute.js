...
route.post('/api/user/RegUser', apiCtrl.RegUser)


route.post('/api/user/CheckUser', apiCtrl.CheckUser)
route.post('/api/user/UpdatePwd', apiCtrl.UpdatePwd)
route.post('/api/user/UpdateUser', apiCtrl.UpdateUser)
route.post('/api/admin/CheckAdmin', apiCtrl.CheckAdmin)
...
//增加点击数
route.get('/api/addclick/:newid', apiCtrl.addclick)
